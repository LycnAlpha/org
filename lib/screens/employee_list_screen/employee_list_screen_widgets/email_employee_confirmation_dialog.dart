...
class EmailEmployeeConfirmationDialog extends StatelessWidget {
  final Employee employee;
  const EmailEmployeeConfirmationDialog({
    super.key,
      ...
      child: AlertDialog(
        ...
        content: SizedBox(
          ...
          child: dialogBoxContent(context,
              'Are you sure you want to email ${employee.firstName} ?'),
        ),
        actions: [
          Row(
