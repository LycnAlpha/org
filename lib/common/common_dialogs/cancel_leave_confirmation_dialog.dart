...
class CancelLeaveConfirmationDialog extends StatelessWidget {
  final Leave leave;
  const CancelLeaveConfirmationDialog({
    super.key,
    required this.leave,
  });
  @override
      ...
      child: AlertDialog(
        ...
        content: SizedBox(
          ...
          child: dialogBoxContent(
              context, 'Are You Sure You Want to cancel this leave request?'),
        ),
        actions: [
          Row(
  ...
  cancelLeave(BuildContext context) async {
    showDialog(
      context: context,
