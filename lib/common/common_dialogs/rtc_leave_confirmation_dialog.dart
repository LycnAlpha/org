...
class RtcLeaveConfirmationDialog extends StatelessWidget {
  final Leave leave;
  const RtcLeaveConfirmationDialog({
    super.key,
    required this.leave,
  });
    ...
    return PopScope(
      ...
      child: AlertDialog(
        ...
        content: SizedBox(
          ...
          child: dialogBoxContent(context,
              'Are You Sure You Want to request to cancel this leave request?'),
        ),
        actions: [
          Row(
  ...
  requesttoCancelLeave(BuildContext context) async {
    showDialog(
      context: context,
