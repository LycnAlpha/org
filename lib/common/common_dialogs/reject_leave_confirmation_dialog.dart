...
class RejectLeaveConfirmationDialog extends StatelessWidget {
  final Leave leave;
      ...
      child: AlertDialog(
        ...
        content: SizedBox(
          ...
          child: dialogBoxContent(
              context, 'Are You Sure You Want to reject this leave request?'),
        ),
        actions: [
          Row(
  ...
  rejectLeave(BuildContext context) async {
    showDialog(
      context: context,
